use crate::masks::{attack_king_by_square_number, attack_knight_by_square_number,
                   initialize_pawn_attack_by_square_number, mask_bishops_attack, mask_rooks_attack, Side};
